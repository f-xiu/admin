...
export const formRules: CustomFormRules = {
	account: [
		createRequiredFormRule("请输入账户"),
		{
			pattern: REGEXP_ACCOUNT,
			message: "账户为6-18位数字/英文字符",
			trigger: "input",
		},
	],
	password: [
	...
	name: [
		createRequiredFormRule("请输入昵称"),
		{
			pattern: REGEXP_NAME,
			message: "昵称为2-12个中英文等一些字符",
			trigger: "input",
		},
	],
	code: [
	...
	email: [{ pattern: REGEXP_EMAIL, message: "邮箱格式错误", trigger: "input" }],
	money: [
		{
			pattern: REGEXP_MONEY,
			message: "余额保留两位小数,且不能为负数",
			trigger: "input",
		},
	],
};
